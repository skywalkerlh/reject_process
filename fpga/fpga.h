...
#define FPGA_TRIGCAMCOUNTERH_REG2 			0x38		//触发相机计数1高16位
...
#define FPGA_VP5OUTPIXELMUN_REG  			0x53		//有效像素个数,vp5,图像宽度
...
#define FPGA_VP6OUTPIXELMUN_REG  			0x58		//有效像素个数,vp6,图像宽度
